...
dxl.PosCnt_Vbase(Motor_ID,p1 + outer_finger_dis,experiment_motor_speed)
...
#エラーが発生するかもしれない項をtryにぶち込む
    try:
        ...
        ##マーカー情報整理
        #fixed_marker_center_X, fixed_marker_center_Y =fixed_marker_center
        #movable_Marker_Center_1_X,movable_Marker_Center_1_Y = movable_marker_centers[0]
        #movable_Marker_Center_2_X, movable_Marker_Center_2_Y = movable_marker_centers[1]
...
dxl.PosCnt_Vbase(Motor_ID,p3 + inner_finger_dis,experiment_motor_speed)
t1 = current_time
...
excel_path = os.path.join(output_dir, f"experiment{date}_queueSize{queue_size}.xlsx")
